...
import com.example.monoplug.databinding.FragmentCreateRoomBinding
import java.util.*


class CreateRoomFragment : Fragment()  ,  DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.root.setOnClickListener {
            findNavController().navigate(R.id.inviteTwoFragment)
        }
        pickDate()
    }
