...
class InviteAllAdapter(var list : List<InviteAll> ) : RecyclerView.Adapter<InviteAllAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.invite_all_design,parent,false)
