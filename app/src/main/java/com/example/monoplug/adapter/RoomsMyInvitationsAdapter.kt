...
class RoomsMyInvitationsAdapter(var list : List<RoomsMyInvitations> ) : RecyclerView.Adapter<RoomsMyInvitationsAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.rooms_my_invitations_design,parent,false)
