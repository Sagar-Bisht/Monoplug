...
class LiveIdeaTradingAdapter(var list : List<LiveIdeaTrading> ) : RecyclerView.Adapter<LiveIdeaTradingAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.live_idea_trading_design,parent,false)
