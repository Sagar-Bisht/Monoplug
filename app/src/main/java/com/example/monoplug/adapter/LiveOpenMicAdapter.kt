...
class LiveOpenMicAdapter(var list : List<LiveOpenMic> ) : RecyclerView.Adapter<LiveOpenMicAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.live_open_mice_design,parent,false)
