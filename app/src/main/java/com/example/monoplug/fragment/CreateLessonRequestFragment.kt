...
import com.example.monoplug.databinding.FragmentCreateLessonRequestBinding
import java.util.*


class CreateLessonRequestFragment : Fragment(),  DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    lateinit var binding: FragmentCreateLessonRequestBinding
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_create_lesson_request, container, false)
        return binding.root
    }
