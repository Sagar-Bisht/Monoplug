...
class RoomUsersPendingAdapter(var list : List<Pending> ) : RecyclerView.Adapter<RoomUsersPendingAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.room_users_pending_design,parent,false)
