...
class MyJobsClosedAdapter(var list : List<MyJobsClosed> , val onClosedClick : OnClosedClick ) : RecyclerView.Adapter<MyJobsClosedAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.my_jobs_closed_design,parent,false)
